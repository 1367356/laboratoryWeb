...
set CLASSPATH=%APP_HOME%\lib\thymeleaf-2.1.6.RELEASE.jar;%APP_HOME%\lib\spring-boot-starter-jdbc-1.5.9.RELEASE.jar;%APP_HOME%\lib\spring-boot-starter-logging-1.5.9.RELEASE.jar;%APP_HOME%\lib\logback-core-1.1.11.jar;%APP_HOME%\lib\spring-boot-starter-tomcat-1.5.9.RELEASE.jar;%APP_HOME%\lib\mockito-core-1.10.19.jar;%APP_HOME%\lib\spring-aop-4.3.13.RELEASE.jar;%APP_HOME%\lib\tomcat-annotations-api-8.5.23.jar;%APP_HOME%\lib\spring-boot-starter-test-1.5.9.RELEASE.jar;%APP_HOME%\lib\hamcrest-library-1.3.jar;%APP_HOME%\lib\mybatis-3.4.4.jar;%APP_HOME%\lib\tomcat-juli-8.5.23.jar;%APP_HOME%\lib\spring-core-4.3.13.RELEASE.jar;%APP_HOME%\lib\xercesImpl-2.11.0.jar;%APP_HOME%\lib\unbescape-1.1.0.RELEASE.jar;%APP_HOME%\lib\spring-expression-4.3.13.RELEASE.jar;%APP_HOME%\lib\jackson-databind-2.8.10.jar;%APP_HOME%\lib\objenesis-2.1.jar;%APP_HOME%\lib\jul-to-slf4j-1.7.25.jar;%APP_HOME%\lib\snakeyaml-1.17.jar;%APP_HOME%\lib\logback-classic-1.1.11.jar;%APP_HOME%\lib\commons-logging-1.2.jar;%APP_HOME%\lib\spring-security-web-4.2.3.RELEASE.jar;%APP_HOME%\lib\mybatis-spring-boot-starter-1.3.0.jar;%APP_HOME%\lib\junit-4.12.jar;%APP_HOME%\lib\spring-tx-4.3.13.RELEASE.jar;%APP_HOME%\lib\log4j-over-slf4j-1.7.25.jar;%APP_HOME%\lib\jackson-core-2.8.10.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\spring-beans-4.3.13.RELEASE.jar;%APP_HOME%\lib\asm-5.0.3.jar;%APP_HOME%\lib\mybatis-spring-1.3.1.jar;%APP_HOME%\lib\json-path-2.2.0.jar;%APP_HOME%\lib\spring-context-support-4.3.13.RELEASE.jar;%APP_HOME%\lib\spring-boot-1.5.9.RELEASE.jar;%APP_HOME%\lib\commons-lang3-3.4.jar;%APP_HOME%\lib\android-json-0.0.20131108.vaadin1.jar;%APP_HOME%\lib\validation-api-1.1.0.Final.jar;%APP_HOME%\lib\jsonassert-1.4.0.jar;%APP_HOME%\lib\log4j-api-2.7.jar;%APP_HOME%\lib\laboratoryWeb-1.0-SNAPSHOT.jar;%APP_HOME%\lib\druid-1.1.6.jar;%APP_HOME%\lib\mybatis-spring-boot-autoconfigure-1.3.0.jar;%APP_HOME%\lib\jcl-over-slf4j-1.7.25.jar;%APP_HOME%\lib\tomcat-embed-core-8.5.23.jar;%APP_HOME%\lib\commons-pool2-2.4.3.jar;%APP_HOME%\lib\tomcat-embed-el-8.5.23.jar;%APP_HOME%\lib\spring-boot-starter-web-1.5.9.RELEASE.jar;%APP_HOME%\lib\hibernate-validator-5.3.6.Final.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar;%APP_HOME%\lib\classmate-1.3.4.jar;%APP_HOME%\lib\spring-boot-starter-thymeleaf-1.5.9.RELEASE.jar;%APP_HOME%\lib\groovy-2.4.13.jar;%APP_HOME%\lib\spring-context-4.3.13.RELEASE.jar;%APP_HOME%\lib\spring-boot-test-1.5.9.RELEASE.jar;%APP_HOME%\lib\jboss-logging-3.3.1.Final.jar;%APP_HOME%\lib\json-smart-2.2.1.jar;%APP_HOME%\lib\mysql-connector-java-5.1.35.jar;%APP_HOME%\lib\assertj-core-2.6.0.jar;%APP_HOME%\lib\log4j-core-2.7.jar;%APP_HOME%\lib\nekohtml-1.9.22.jar;%APP_HOME%\lib\thymeleaf-extras-springsecurity4-2.1.3.RELEASE.jar;%APP_HOME%\lib\spring-webmvc-4.3.13.RELEASE.jar;%APP_HOME%\lib\tomcat-embed-websocket-8.5.23.jar;%APP_HOME%\lib\commons-net-3.1.jar;%APP_HOME%\lib\thymeleaf-layout-dialect-1.4.0.jar;%APP_HOME%\lib\xml-apis-1.4.01.jar;%APP_HOME%\lib\spring-security-core-4.2.3.RELEASE.jar;%APP_HOME%\lib\ognl-3.0.8.jar;%APP_HOME%\lib\spring-boot-starter-security-1.5.9.RELEASE.jar;%APP_HOME%\lib\spring-boot-starter-1.5.9.RELEASE.jar;%APP_HOME%\lib\spring-boot-autoconfigure-1.5.9.RELEASE.jar;%APP_HOME%\lib\spring-test-4.3.13.RELEASE.jar;%APP_HOME%\lib\spring-boot-test-autoconfigure-1.5.9.RELEASE.jar;%APP_HOME%\lib\spring-boot-devtools-1.5.9.RELEASE.jar;%APP_HOME%\lib\javassist-3.21.0-GA.jar;%APP_HOME%\lib\jackson-annotations-2.8.0.jar;%APP_HOME%\lib\spring-security-config-4.2.3.RELEASE.jar;%APP_HOME%\lib\thymeleaf-spring4-2.1.6.RELEASE.jar;%APP_HOME%\lib\druid-spring-boot-starter-1.1.6.jar;%APP_HOME%\lib\spring-jdbc-4.3.13.RELEASE.jar;%APP_HOME%\lib\accessors-smart-1.1.jar;%APP_HOME%\lib\spring-boot-starter-cache-1.5.9.RELEASE.jar;%APP_HOME%\lib\spring-web-4.3.13.RELEASE.jar;%APP_HOME%\lib\tomcat-jdbc-8.5.23.jar
